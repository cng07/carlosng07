export const resumeData = {
  ...
  about: [
    "I’m a Test Automation Engineer with 7+ years of experience in software testing, helping teams ship more reliable releases through practical and maintainable automation. These days I mainly focus on UI and API automation using Playwright with TypeScript, building test suites that are fast, stable, and easy to maintain.",
    ...
    "Main tools I use: Playwright (TypeScript), API testing, Azure DevOps pipelines, Postman, Jira.",
    "If you need help building or improving your test automation, I’m happy to jump in and help."
  ],
