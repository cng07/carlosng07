...
const routes = [
    ...
    },
    {
        ...
        label: 'Test Reports',
        element: TestReports,
        meta: { title: 'Test Reports', description: 'Automated test results from CI pipelines and GitHub Actions.', image: baseImage, siteName }
    },
    {
        path: '/qa-lab',
        label: 'QA Lab',
...
const primaryNavOrder = ['Home', 'Projects', 'Test Reports', 'QA Lab', 'About', 'Contact'];
